...
import (
	...
	repository6 "github.com/0xsj/nexus-go/internal/audit/infrastructure/repository"
	v1_6 "github.com/0xsj/nexus-go/internal/audit/interface/http/v1"
	"github.com/0xsj/nexus-go/internal/email"
	command3 "github.com/0xsj/nexus-go/internal/email/application/command"
	query3 "github.com/0xsj/nexus-go/internal/email/application/query"
	repository3 "github.com/0xsj/nexus-go/internal/email/infrastructure/repository"
	v1_3 "github.com/0xsj/nexus-go/internal/email/interface/http/v1"
	command4 "github.com/0xsj/nexus-go/internal/flags/application/command"
	query4 "github.com/0xsj/nexus-go/internal/flags/application/query"
	repository4 "github.com/0xsj/nexus-go/internal/flags/infrastructure/repository"
	"github.com/0xsj/nexus-go/internal/flags/interface/http/admin"
	v1_4 "github.com/0xsj/nexus-go/internal/flags/interface/http/v1"
	...
	query5 "github.com/0xsj/nexus-go/internal/permissions/application/query"
	repository5 "github.com/0xsj/nexus-go/internal/permissions/infrastructure/repository"
	v1_5 "github.com/0xsj/nexus-go/internal/permissions/interface/http/v1"
	command2 "github.com/0xsj/nexus-go/internal/tenant/application/command"
	query2 "github.com/0xsj/nexus-go/internal/tenant/application/query"
	repository2 "github.com/0xsj/nexus-go/internal/tenant/infrastructure/repository"
	v1_2 "github.com/0xsj/nexus-go/internal/tenant/interface/http/v1"
	"github.com/0xsj/nexus-go/pkg/cache"
	"github.com/0xsj/nexus-go/pkg/database"
	postgres2 "github.com/0xsj/nexus-go/pkg/database/postgres"
	email2 "github.com/0xsj/nexus-go/pkg/email"
